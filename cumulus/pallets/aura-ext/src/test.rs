...
use sp_core::{crypto::Pair, Blake2Hasher, Get, H256};
...
use sp_state_machine::{TestExternalities as TestExt, TrieBackendBuilder};
use sp_trie::{
...
#[test]
fn test_block_executor_with_storage_proof_size() {
	...
	ext.execute_with(|| {
		BlockExecutor::<Test, TestExecutive>::execute_block(block.into());
	});
}
